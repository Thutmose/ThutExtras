...
public class DeformableVertex extends Vertex
{
    public DeformableVertex    copy             = null;
    ...
    public DeformableVertex(DeformableVertex vertex)
    {
    ...
    public DeformableVertex(float x, float y, float z, float xn, float yn, float zn, int ID)
    {
        super(x, y, z);
        this.xn = xn;
        this.yn = yn;
    ...
    public void applyModified(Bone bone, float weight)
    {
        ...
        {
            initModVectors();
            Vector4f locTemp = Matrix4f.transform(modified, this.baseLoc, null);
            Vector4f normalTemp = Matrix4f.transform(modified, this.baseNormal, null);
